...
window.onload = (event) => {
	...
	fetch("/v15/dic_target.json").then(resp => resp.json()).then(json => {
		...
		fetch("/v15/dic_player.json").then(resp => resp.json()).then(json => {
			...
			fetch("/v15/dic_original.json").then(resp => resp.json()).then(json => {
