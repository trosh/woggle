...
window.onload = (event) => {
	...
	fetch("/v17/dic_target.json").then(resp => resp.json()).then(json => {
		...
		fetch("/v17/dic_player.json").then(resp => resp.json()).then(json => {
			...
			fetch("/v17/dic_original.json").then(resp => resp.json()).then(json => {
